                ...
                itemBuilder: (context,index){
                  ...
                  return Padding(
                    ...
                    child: Container(
                      child: Column(
                        children: [
                          Header(ds['userName'],ds['title'],ds['goalCategory'],ds['goalStatus']),
                          CachedNetworkImage(
                          ...
                          Footer(ds['userName'],ds['desc'],//Time
                             )
                        ],
                      ),
                    ),
        ...
        Row(
          children: [
            ...
            Column(
              ...
              children: [
                Text(title,style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: kLight),),
                Text(category),
              ],
            ),
          ],
...
Widget Footer(String name,String description,//DateTime time
){
  return Container(
      width: double.infinity,
      height: Get.height*0.1,
